...
const TeacherSidebar = ({ isOpen, onClose }) => {
    ...
    const fetchNotifications = async () => {
        try {
            const res = await axios.get('/api/v1/teachers/notifications');
            if (res.data?.data?.rejectedCount) {
                setNotificationCount(res.data.data.rejectedCount);
            } else {
        ...
        <aside className={`sidebar ${isOpen ? 'active' : ''}`}>
            ...
            <nav className="sidebar-nav">
                ...
                <Link
                    ...
                    className={`sidebar-item ${isActive('/teacher/assignments') || location.pathname.startsWith('/teacher/assignments') ? 'active' : ''}`}
                    onClick={onClose}
                >

...
const OfferingForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('/api/v1/offerings', offeringData);
            showAlert('Offering created successfully!', 'success');
            ...
            showAlert(error.response?.data?.message || error.response?.data?.error || 'Operation failed', 'error');
        } finally {
            setLoading(false);
        }
    };
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
                    ...
                    <div>
                        ...
                        <p className="page-subtitle" style={{ margin: 0 }}>
                            Schedule a course offering for the semester
                        </p>
                    </div>
                </div>
            </div>
